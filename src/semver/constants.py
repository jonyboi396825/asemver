...
* In dec() of VersionNumber, used when _number attribute is 0
...
* In inc() of Pre, used when pos is VPos.PRE and _pre attribute is None
* In dec() of Pre, used when pos is VPos.PRE and _pre attribute is None
"""
